            ...
            <div class="jumbotron">
                ...
                <div id="content">
                    ...
                    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                        ...
                        <li><a href="#msj1" data-toggle="tab">Mensajes de Buzón 1</a></li>
                        <li><a href="#msj2" data-toggle="tab">Mensajes de Buzón 2</a></li>
                    ...
                    <div id="my-tab-content" class="tab-content">
                                        ...
                                        <td style="width:10%;">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <?php } else { ?>
                                                    <div
                                                        style="height: 22px; width: 80%; text-align: center; margin-top: -5px;">
                                                        <?php } ?>
                        ...
                        <div class="tab-pane" id="msj1">
                            ...
                            $path10001 = "/var/www/html/homeinsted/voicemail/10000";
